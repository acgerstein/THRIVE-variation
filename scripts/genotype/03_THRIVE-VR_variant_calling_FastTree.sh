...
gatk --java-options "-Xmx4g" GenotypeGVCFs --dbsnp /home/abdul/scratch/C.albicans/data_in/reference/A22_Jones_PMID_15123810_Polymorphisms_hapA.vcf.gz -R $ref -V $output/230131_THRIVE_calb_combined.g.vcf.gz -O $output/230131_THRIVE_calb_joint_called_raw.vcf.gz
